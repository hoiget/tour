          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="a-login.php" class="logo d-flex align-items-center w-auto">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <a class="dn" href="nv-login.php">Đăng nhập nhân viên</a>
                    <h5 class="card-title text-center pb-0 fs-4">Đăng nhập</h5>
                  </div>

                
                  <form class="my-form row g-3 needs-validation" id="loginforma" action="./api/apia.php" method="post" novalidate> 
                  <input type="hidden" name="action" value="login">
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" onclick="showlogin()">Đăng nhập</button>
                    </div>
