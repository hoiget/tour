...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 25, 2025 lúc 05:07 AM
...
INSERT INTO `rentals` (`rental_id`, `customer_name`, `customer_phone`, `customer_email`, `vehicle_type`, `driver_id`, `pickup_time`, `pickup_location`, `dropoff_location`, `notes`, `created_at`) VALUES
(1, 'sss', '083929922', 'e@gmail.com', '4 chỗ', 1, '2025-03-26 09:14:00', 'Tp hồ', 'Hà ', 'ss', '2025-03-25 02:14:38');
...
(1, 'Phuc Hung', 'sssss', 'phuc@gmail.com', '0987389890', 'pt.png', 'cb0343fa02f5e80de7ed84427f227af1', '1995-02-24', NULL, NULL),
...
--
ALTER TABLE `booking_detail_tour`
  MODIFY `Sr_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;
...
--
ALTER TABLE `participant`
  MODIFY `idpar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;
