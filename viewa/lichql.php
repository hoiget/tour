...
<div class="calendar-container">
  <div class="calendar-header" style="margin-top: 10px">
    ...
    <a href="indexa.php?lichql"><button style="border-radius: 5%; border: 1px solid grey;">Hiện tại</button></a>
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (cell) {
        cell.innerHTML = `<div class="shift-box"><strong>Làm việc</strong></div>`;
    }
});
