...
function generateRandomString(length) {
 ...
 function xemthanhtoan() {
        ...
        const id = urlParams6.get('idtt');
    


        $.ajax({
            url: './api/api.php?action=thanhtoan&idtt=' + id,
            type: 'GET',
...
console.log(response)
                ...
                if (response && response.length > 0) {
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="order_desc" name="order_desc" type="text" value="${event.Tour_name}" readonly >
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="txt_billing_mobile"
                               name="txt_billing_mobile" type="text" value="${event.Phone_num}"/>   
                    </div>
                    <div class="form-group">
                        <label >Địa chỉ (*)</label>
